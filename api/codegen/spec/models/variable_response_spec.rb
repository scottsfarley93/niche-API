...
# Unit tests for SwaggerClient::VariableResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VariableResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::VariableResponse.new
  end
  ...
  describe 'test an instance of VariableResponse' do
    it 'should create an instact of VariableResponse' do
      @instance.should be_a(SwaggerClient::VariableResponse) 
    end
  end
