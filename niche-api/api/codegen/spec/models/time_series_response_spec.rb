...
# Unit tests for SwaggerClient::TimeSeriesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimeSeriesResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::TimeSeriesResponse.new
  end
  ...
  describe 'test an instance of TimeSeriesResponse' do
    it 'should create an instact of TimeSeriesResponse' do
      @instance.should be_a(SwaggerClient::TimeSeriesResponse) 
    end
  end
