...
-- Started on 2016-06-15 09:37:17 CDT
...
--
-- TOC entry 2187 (class 1262 OID 16393)
-- Name: paleo; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE paleo WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'English_United States.1252' LC_CTYPE = 'English_United States.1252';


ALTER DATABASE paleo OWNER TO postgres;
...
--
-- TOC entry 192 (class 1259 OID 16641)
-- Name: averagingperiodtypes; Type: TABLE; Schema: public; Owner: paleo
--
...
CREATE TABLE rasterindex (
    ...
    "tableName" text,
    CONSTRAINT futureyears CHECK ((yearsbp > '-100'::integer))
);
