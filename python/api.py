...
def getData():
    ...
    ## THIS IS THE GREATER THAN QUERY
    greaterThanQuery = '''
        SELECT
    ...
    cursor.execute(greaterThanQuery, params)
    greaterThanRows = cursor.fetchall()
    ...
    cursor.execute(lessThanQuery, params)
